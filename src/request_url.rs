...
fn test_trigger_request_url() {
  let expected = "http://api.pusherapp.com/apps/3/events?auth_key=key&auth_timestamp=1353088179&auth_version=1.0&body_md5=ec365a775a4cd0599faeb73354201b6f&auth_signature=3695357e49aa04ae6f3cd76039dcefd82da079d0564bac566033d48ebae75459";
  let mut request_url = Url::parse("http://api.pusherapp.com/apps/3/events").unwrap();
  let payload = "{\"name\":\"foo\",\"channels\":[\"project-3\"],\"data\":\"{\\\"some\\\":\\\"data\\\"}\"}";
  update_request_url("POST", &mut request_url, "key", "secret", "1353088179".to_string(), Some(payload), None);
